...
From September to December 2024, I worked at the **Ontario Institute for Cancer Research (OICR)** as a **Front-End Developer & GitHub Specialist**.

I specifically worked at [Bioinformatics.ca](https://bioinformatics.ca/) under Adaptive Oncology.
...
- [POC page using **Quarto**](https://cbw-dev.github.io/quarto-POC/), a publishing system.

## Templates and Documentation

These templates are made for future workshop creators to be able to easily make a workshop website without any previous website development experience. Each template comes with corresponding documentation to help explain to (new) users how to use the templates.

### Jupyter Book


- CBW's Jupyter Book [Template](https://cbw-dev.github.io/jupyterbook-template/)
- CBW's Jupyter Book Template [Documentation](https://cbw-dev.github.io/jupyterbook-docs/)

```{note}
I used this template for my own personal website (this website)!
```
...
- CBW's Bookdown Original Template [Documentation](https://cbw-dev.github.io/bookdown-docs/)

## Additional Links

Additional links to websites I worked on are available [here](https://cbw-dev.github.io/).
